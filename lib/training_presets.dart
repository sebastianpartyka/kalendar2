...
class TrainingPresets extends StatelessWidget {
  const TrainingPresets({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const Text('Routes / Training presets'),
          centerTitle: true,
        ...
        body: Center(
          child: Column(
            ...
            children: <Widget>[
              Text(
                'Routes/training presets zawartość',
